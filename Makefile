...
#    Updated: 2020/03/11 13:53:09 by ikuklina         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstmap.c ft_memdel.c ft_putendl_fd.c ft_get_max.c ft_get_min.c ft_list_size.c ft_count_symb_char.c ft_countnum.c \
...
ft_lstmap.o ft_memdel.o ft_putendl_fd.o ft_get_max.o ft_get_min.o ft_list_size.o ft_count_symb_char.o ft_countnum.o \
