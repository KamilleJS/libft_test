...
#    Updated: 2020/03/11 10:30:37 by ikuklina         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstmap.c ft_memdel.c ft_putendl_fd.c ft_get_max.c ft_get_min.c ft_list_size.c ft_count_symb_char.c ft_countwords.c \
...
ft_striter.o ft_striteri.o  ft_strmap.o ft_strmapi.o ft_strequ.o ft_strnequ.o  ft_strsub.o ft_strjoin.o \
...
ft_lstmap.o ft_memdel.o ft_putendl_fd.o ft_get_max.o ft_get_min.o ft_list_size.o ft_count_symb_char.o ft_countwords.o \
