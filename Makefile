...
#    Updated: 2020/03/08 14:31:02 by ikuklina         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putendl.c ft_putnbr_fd.c ft_putnbr.c ft_putstr_fd.c ft_putstr.c ft_strcat.c ft_replace.c \
...
ft_strstr.c ft_strtrim.c ft_strsub.c ft_tolower.c ft_toupper.c ft_strrchr.c ft_getpositiv.c \
...
ft_putendl.o ft_putnbr_fd.o ft_putnbr.o ft_putstr_fd.o ft_putstr.o ft_strcat.o ft_replace.o \
...
ft_strstr.o ft_strtrim.o ft_strsub.o ft_tolower.o ft_toupper.o ft_strrchr.o ft_getpositiv.o \
