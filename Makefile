...
#    Updated: 2020/03/11 10:01:34 by ikuklina         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strtrim.c ft_strsplit.c ft_countwords.c ft_itoa.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
ft_lstmap.c ft_memdel.c ft_putendl_fd.c ft_get_max.c ft_get_min.c ft_list_size.c ft_countnum.c
...
ft_strtrim.o ft_strsplit.o ft_countwords.o ft_itoa.o ft_lstnew.o ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o \
ft_lstmap.o ft_memdel.o ft_putendl_fd.o ft_get_max.o ft_get_min.o ft_list_size.o ft_countnum.o
