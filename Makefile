...
#    Updated: 2020/03/11 14:11:16 by ikuklina         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_tolower.c ft_toupper.c ft_memmove.c ft_strstr.c ft_memchr.c ft_strlcat.c ft_memcmp.c ft_strnstr.c ft_memalloc.c ft_getpositiv.c \
...
ft_strset.c ft_striter.c ft_striteri.c  ft_strmap.c ft_strmapi.c ft_strequ.c ft_strnequ.c  ft_strsub.c ft_strjoin.c ft_length.c \
...
ft_tolower.o ft_toupper.o ft_memmove.o ft_strstr.o ft_memchr.o ft_strlcat.o ft_memcmp.o ft_strnstr.o ft_memalloc.o ft_getpositiv.o \
...
ft_strset.o ft_striter.o ft_striteri.o  ft_strmap.o ft_strmapi.o ft_strequ.o ft_strnequ.o  ft_strsub.o ft_strjoin.o ft_length.o \
